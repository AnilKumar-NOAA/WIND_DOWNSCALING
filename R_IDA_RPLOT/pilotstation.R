...
wind.df3 = read.csv(file="pilotstation_east_6min.csv")
attach(wind.df3)
head(wind.df3)
tail(wind.df3)
...
title(main="Pilot's Station East, LA \n Station - 8760922", col.main="black", cex=4)
...
# the actual plots 
legend(1, 10, c("OBS","HWRF-LES"), cex=0.90, 
...
plot(OBS_PSFC,  type='o', col="black", ylim=c(960,1020), xaxt="n",ann=FALSE, cex.axis=1.5, cex=1.5)
...
legend(1, 970, c("OBS","HWRF-LES"), cex=0.90, 
       col=c("black","red"), pch=21:22, lty=1:2);
labels1 = c("06/29","12/29","18/29","00/30","06/30")

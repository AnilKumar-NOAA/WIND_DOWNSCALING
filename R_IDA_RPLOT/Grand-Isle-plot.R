...
wind.df3 = read.csv(file="grandisle_6min.csv")
attach(wind.df3)
head(wind.df3)
tail(wind.df3)
...
plot(OBS_WSPD,  type='o', col="black", ylim=c(0,100), xaxt="n",ann=FALSE, cex.axis=1.5, cex=1.5)

lines(HWRFLES_WSPD, type="o", pch=23, lty=2, col="red")


# Create a title with a red, bold/italic font
title(main="Grand Isle, LA \n Station - 8761724", col.main="black", cex=4)
...
# the actual plots 
legend(1, 90, c("OBS","HWRF-LES"), cex=0.90, 
...
plot(OBS_GUST,  type='o', col="black", ylim=c(0,100), xaxt="n",ann=FALSE, cex.axis=1.5, cex=1.5)

...
wind.df3 = read.csv(file="Baywaveland_hourly.csv")
attach(wind.df3)
head(wind.df3)
tail(wind.df3)
...
plot(OBS_WSPD,  type='o', col="black", ylim=c(0,40), xaxt="n",ann=FALSE, cex.axis=1.5, cex=1.5)

lines(HWRFLES_WSPD, type="o", pch=23, lty=2, col="red")


# Create a title with a red, bold/italic font
title(main="Bay Waveland Yach, LA \n Station - 8747437", col.main="black", cex=4)
...
# the actual plots 
legend(1, 30, c("OBS","HWRF-LES"), cex=0.90, 
       col=c("black","red"), pch=21:22, lty=1:2);
labels1 = c("18/28","00/29","06/29","12/29","18/29","00/30","06/30","12/30")

axis(1, at=seq(1,48,6), labels=labels1,lwd=2, cex.axis=1.5, cex=1.5)

# PLOT WIND GUST

plot(OBS_GUST,  type='o', col="black", ylim=c(0,40), xaxt="n",ann=FALSE, cex.axis=1.5, cex=1.5)
...
legend(1, 30, c("OBS","HWRF-LES"), cex=0.90, 
       col=c("black","red"), pch=21:22, lty=1:2);
abels1 = c("18/28","00/29","06/29","12/29","18/29","00/30","06/30","12/30")

axis(1, at=seq(1,48,6), labels=labels1,lwd=2, cex.axis=1.5, cex=1.5)


plot(OBS_PSFC,  type='o', col="black", ylim=c(980,1020), xaxt="n",ann=FALSE, cex.axis=1.5, cex=1.5)
...
legend(1, 990, c("OBS","HWRF-LES"), cex=0.90, 
       col=c("black","red"), pch=21:22, lty=1:2);
abels1 = c("18/28","00/29","06/29","12/29","18/29","00/30","06/30","12/30")

...
if (RUN_TYPE == 'tide_spinup') | \
   ...
   #AW plot_adcirc.plot_wlv(storm=STORM, datafile1=DATAFILE, datafile2=DATAFILE2)
   plot_adcirc.plot_wlv(storm=STORM, datafile1=DATAFILE, datafile2=DATAFILE2, domain='full',
                               lonmin=base_info.lonmin_plot_full,
                               lonmax=base_info.lonmax_plot_full,
                               latmin=base_info.latmin_plot_full,
                               latmax=base_info.latmax_plot_full)
   #plot_adcirc.plot_wlv(storm=STORM, datafile1=DATAFILE, datafile2=DATAFILE2, domain='regional',
   ...
   plot_adcirc.plot_wlv(storm=STORM, datafile1=DATAFILE, datafile2=DATAFILE2, domain='landfall',
   ...
   #plot_adcirc.plot_cur(storm=STORM, datafile1=DATAFILE)
...
if (RUN_TYPE == 'atm2wav2ocn') | \
   ...
   DATAFILE = sp.getoutput('ls -t ww3*cur*.nc | head -1')
   print('Plotting fields for STORM, DATAFILE: '+STORM+', '+DATAFILE)
   #plot_ww3_unstr.plot_cur(storm=STORM, datafile1=DATAFILE, domain='full',
   #                           lonmin=base_info.lonmin_plot_full,
   #                           lonmax=base_info.lonmax_plot_full,
   #                           latmin=base_info.latmin_plot_full,
   #                           latmax=base_info.latmax_plot_full)
   #plot_ww3_unstr.plot_cur(storm=STORM, datafile1=DATAFILE, domain='regional',
   #                            lonmin=base_info.lonmin_plot_regional,
   #                            lonmax=base_info.lonmax_plot_regional,
   #                            latmin=base_info.latmin_plot_regional,
   #                            latmax=base_info.latmax_plot_regional)
   #plot_ww3_unstr.plot_cur(storm=STORM, datafile1=DATAFILE, domain='landfall',
   #                            lonmin=base_info.lonmin_plot_landfall,
   #                            lonmax=base_info.lonmax_plot_landfall,
   #                            latmin=base_info.latmin_plot_landfall,
   #                            latmax=base_info.latmax_plot_landfall)

...
obs_wdir = dataset[['OBS_WDIR_CM']]
mod_wdir = dataset[['MODEL_WDIR_CM']]
...
plt.plot(time,obs_wdir, color='blue', label='OBS')
plt.plot(time,mod_wdir, color='red', label='MODEL')
plt.ylim([100,400])
plt.xlim([0,45])
plt.xlabel('Oct 2012 (UTC/Date)', fontsize=30)
plt.ylabel('Wind Dir (Deg)', fontsize=30)

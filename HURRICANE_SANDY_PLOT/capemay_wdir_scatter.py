...
obs_gust = dataset[['OBS_WDIR_CM']].fillna(0)
mod_gust = dataset[['MODEL_WDIR_CM']].fillna(0)
...
plt.text(5.0,  330.0, "Slope="+"{:.3f}".format(slope), fontsize=16)
plt.text(5.0,  310.0, "RMSE="+"{:.4f}".format(rmse), fontsize=16)
plt.text(5.0,  290.0, "SI="+"{:.4f}".format(si), fontsize=16)
plt.title('Cape May, NJ\nStation 8536110\nWind Dir (10m) Deg', fontsize=20)
plt.legend()
plt.show()
